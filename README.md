...
## ขอบเขต
ดึงสรุปรายวันจากเมนู “ยอดขายร้าน” ภายใน Google Sheets บนคอมพิวเตอร์ โดยไม่เผยแพร่ Apps Script เป็นเว็บแอป ตั้งค่าตาม integrations/google-sheets/README.md คำขออ่านยอดรวมยืนยันด้วยคีย์เฉพาะ วันที่เดิมอัปเดตแถวเดิม และควรดึงใหม่หลังยกเลิกบิลย้อนหลัง ไม่มีการเปิด billing เพิ่ม
